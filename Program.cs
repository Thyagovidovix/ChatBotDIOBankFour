...
namespace Bot
{
    class Program
    {
        ...
        private static void BotClient_OnMessage(object sender, Telegram.Bot.Args.MessageEventArgs e)
        {
            ...
            {
                FileStream fs = File.OpenRead(@"C:\Users\THYAGO VIDOVIX\BankfourBot\Bankfour\Cartão Carrefour.jpg");
            ...
            {
                FileStream fs = File.OpenRead(@"C:\Users\THYAGO VIDOVIX\BankfourBot\Bankfour\Crédito Pessoal.jpg");
            ...
            {
                FileStream fs = File.OpenRead(@"C:\Users\THYAGO VIDOVIX\BankfourBot\Bankfour\Pag Contas.jpg");
            ...
            {
                FileStream fs = File.OpenRead(@"C:\Users\THYAGO VIDOVIX\BankfourBot\Bankfour\Saque rápido.jpg");
            ...
            {
                FileStream fs = File.OpenRead(@"C:\Users\THYAGO VIDOVIX\BankfourBot\Bankfour\SMS Controle Total.jpg");
